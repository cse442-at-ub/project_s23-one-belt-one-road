			...
			<div style="text-align: center;">
				...
				<ul class="landing-item-list">
					<li class="item-block-tall">
						<a href="product_detail_page.php"><img src="/images/item-spam.png" alt="item" class="item-image-button"></br>SPAM 12 OZ</a>
						<span class="landing-item-title">$ 4.42<span>
					</li>
					<li class="item-block-tall">
						<a href="product_detail_page.php"><img src="/images/item-mug.png" alt="item" class="item-image-button"></br>Handmade Mug</a>
					...
					<li class="item-block-tall">
						<a href="product_detail_page.php"><img src="/images/item-fries.jpg" alt="item" class="item-image-button"></br>Just Potatoes</a>
